    ...
    <div class="auto-container">
        <div class="content-box">
            ...
            <ul class="bread-crumb clearfix">
                ...
                <li><a href="{{ route('public.surgical-treatments.all') }}">Surgical Treatments</a></li>
                ...
                <div class="blog-sidebar ml_40">
                        ...
                        <div class="post-inner">
                            ...
                            <div class="post">
                                ...
                                <figure class="post-thumb">
                                    <a href="{{ route('public.surgical-treatments.Details', $recent->id) }}">
                                ...
                                @endif
                                <h4>
                                    <a href="{{ route('public.surgical-treatments.Details', $recent->id) }}">{{ $recent->name }}</a>
                                </h4>
                    ...
                    <div class="sidebar-widget contact-widget">
                        ...
                        <div class="widget-content">
                            <p>Contact us for more information about this treatment. <a href="{{ route('public.surgical-treatments.all') }}" class="">Contact Us</a></p>
