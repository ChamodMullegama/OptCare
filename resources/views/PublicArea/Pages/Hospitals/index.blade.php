    ...
    <div class="auto-container">
        ...
        <div class="row mb-4">
            <div class="col-md-8 mx-auto">
                <form action="{{ route('public.eye-hospitals.search') }}" method="GET">
        ...
        <div class="row clearfix">
                        ...
                        <div class="inner-box">
                            @if($hospital->image)
                                <figure class="image-box">
                                    ...
                                    <a href="{{ route('public.eye-hospitals.details', ['hospitalId' => $hospital->hospitalId]) }}">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li><i class="fas fa-phone"></i> {{ $hospital->contact_number }}</li>
                                    </ul>
                                    <p>{{ Str::limit(strip_tags($hospital->description), 100) }}</p>
                                    <div class="link">
                                        <a href="{{ route('public.eye-hospitals.details', ['hospitalId' => $hospital->hospitalId]) }}">
                                            Details
                                        </a>
            ...
            @empty
                <div class="col-12 text-center py-5">
                    ...
                    <a href="{{ route('public.eye-hospitals.all') }}" class="theme-btn btn-one"
                       style="padding: 10px 30px; font-size: 14px; background-color: #03c0b4; border-color: #03c0b4; color: #fff; transition: all 0.3s ease; border-radius: 40px;"
                       onmouseover="this.style.backgroundColor='black'; this.style.borderColor='black';"
                       onmouseout="this.style.backgroundColor='#1abc9c'; this.style.borderColor='#1abc9c';">
                       View All Hospitals
