        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="card-title">Service Image List</h5>
                  <button class="btn btn-dark" onclick="window.location.href='{{ route('service.all') }}'">
...
<div class="modal fade" id="deleteImageModal" tabindex="-1" aria-labelledby="deleteServiceModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteServiceForm" action="{{ route('Service.viewServiceImageDelete') }}" method="POST">
                @csrf
