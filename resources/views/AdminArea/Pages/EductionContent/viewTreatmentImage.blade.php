        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="card-title">Treatment Image List</h5>
                    <button class="btn btn-dark" onclick="window.location.href='{{ route('treatments.all') }}'">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="basicExample" class="table truncate m-0 align-middle">
                            ...
                            <tbody>
                                @foreach ($treatment_images as $item)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $item->treatmentImageId }}</td>
                                        <td>
                                            @if ($item->image)
...
<div class="modal fade" id="deleteImageModal" tabindex="-1" aria-labelledby="deleteImageModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteImageForm" action="{{ route('Treatments.viewTreatmentImageDelete') }}" method="POST">
                @csrf
