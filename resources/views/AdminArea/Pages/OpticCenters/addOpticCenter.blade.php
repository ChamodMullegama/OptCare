            ...
            <div class="card" style="height: 600px;">
                <div class="card-body">
                    <div class="custom-tabs-container">
                        ...
                        <form id="addOpticCenterForm" action="{{ route('optic.centers.add') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-xxl-6 col-lg-6 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="hospital_name" name="hospital_name" placeholder="Enter Optic Center Name" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-lg-6 col-sm-12">
                                        ...
                                        <div class="col-xxl-6 col-lg-6 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="open_days" name="open_days" placeholder="e.g., Weekdays, Weekends">
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-lg-6 col-sm-12">
                                            <div class="mb-3">
