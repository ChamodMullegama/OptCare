            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="custom-tabs-container">
                        ...
                        <!-- Tab content starts -->
                        <form id="addDoctorForm" action="{{ route('doctors.add') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="doctorId" name="doctorId" placeholder="Auto-generated" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" id="designation" name="designation">
                                                        <option value="">Select</option>
                                                    <option value="General Ophthalmologist">General Ophthalmologist</option>
                                        ...
                                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="blood_group" name="blood_group" required placeholder="Enter Experience">
                                        ...
                                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="password" name="password" class="form-control" placeholder="Password must be 8-20 characters long">
...
function initializeQuillEditor() {
    if (!editor) {
        editor = new Quill('#fullEditorbio', {
            theme: 'snow',
            modules: {
                toolbar: [
                    [{ 'header': [1, 2, 3, false] }],
